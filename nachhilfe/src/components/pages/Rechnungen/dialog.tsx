...
export const RechnungenDialog = (props: any) => {
                                ...
                                return (
                                    <>
                                        ...
                                        >
                                            ...
                                            <Heading size="xs" bold>  Datum: {s.datum} um {s.uhrzeit} (Dauer {s.dauer}h)</Heading>
                                            <Heading size="xs">   Preis: {s.preis}€</Heading>
                                            <Heading size="xs">   Bezahlung: {s.bezahlungErfolgt === 'butp' ? ("Bezahlung durch BuTP") : ("Noch nicht bezahlt")}</Heading>
                                            <Center size="2" bg="primary.0"></Center>
                                        </Box>
                                    </>
                                )
